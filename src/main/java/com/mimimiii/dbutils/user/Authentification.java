...
//sich aktuelle user merken / einloggen [liefert ein token. TOKEN -  kommt im header von dem request mit!]/ wer akt user ist.
   ...
   /*
    public static String login(String getUsername, String getPassword) {
      ...
      //   Liste aller user holen ; List<getUsername>
        //merken wer aktuelle user ist.

     //   if (username )
        // return im string den token.
